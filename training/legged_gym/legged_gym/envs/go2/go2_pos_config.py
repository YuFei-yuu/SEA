...
class Go2PosDepthStairsCfg(Go2PosDynamicBaseCfg):
    ...
    class terrain(Go2PosDynamicBaseCfg.terrain):
        ...
        low_obstacle_boxes = (
            ...
            (1.45, 0.85, 0.45, 0.35, 0.08),
            (1.45, 2.15, 0.40, 0.30, 0.10),
            (1.45, 3.45, 0.50, 0.35, 0.12),
            (1.45, 6.10, 0.45, 0.30, 0.08),
            (1.45, 7.40, 0.40, 0.35, 0.10),
            (1.45, 8.75, 0.50, 0.30, 0.12),
            (2.05, 1.50, 0.40, 0.35, 0.10),
            (2.05, 2.80, 0.50, 0.30, 0.12),
            (2.05, 4.10, 0.45, 0.35, 0.08),
            (2.05, 6.75, 0.40, 0.30, 0.10),
            (2.05, 8.05, 0.50, 0.35, 0.12),
            (2.05, 9.15, 0.45, 0.30, 0.08),
            (2.65, 0.85, 0.50, 0.30, 0.12),
            (2.65, 2.15, 0.45, 0.35, 0.08),
            (2.65, 3.45, 0.40, 0.30, 0.10),
            (2.65, 6.10, 0.50, 0.35, 0.12),
            (2.65, 7.40, 0.45, 0.30, 0.08),
            (2.65, 8.75, 0.40, 0.35, 0.10),
            (3.25, 1.50, 0.45, 0.30, 0.08),
            (3.25, 2.80, 0.40, 0.35, 0.10),
            (3.25, 4.10, 0.50, 0.30, 0.12),
            (3.25, 6.75, 0.45, 0.35, 0.08),
            (3.25, 8.05, 0.40, 0.30, 0.10),
            (3.25, 9.15, 0.50, 0.35, 0.12),
            (3.85, 0.85, 0.40, 0.35, 0.10),
            (3.85, 2.15, 0.50, 0.30, 0.12),
            (3.85, 3.45, 0.45, 0.35, 0.08),
            (3.85, 5.85, 0.40, 0.30, 0.10),
            (3.85, 7.15, 0.50, 0.35, 0.12),
            (3.85, 8.45, 0.45, 0.30, 0.08),
        )
